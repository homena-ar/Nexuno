...
const nav_anims = {
    ...
    show_dropdown: (target) => {
        ...
        gsap.to(
            [current_menu, current_menu.querySelectorAll(':scope > li > a')],
            {
                autoAlpha: 1,
            }
        );
...
const create_back_element = () => {
    ...
    child.href = '#';
    child.innerHTML =
        '<div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>arrow-right</title><path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" /></svg></svg></div>' +
        'Back';
...
export const create_back_element_wrapper = () => {
    let sub_menus = document.querySelectorAll(
